    ...
    new InstagramStrategy(
      {
        ...
        clientSecret: INSTA_APP_SECRET,
        callbackURL:'https://oolook.azurewebsites.net/login/insta/auth/callback', // Replace with your callback URL
      },
...
router.get(
  ...
  (req, res) => {
    ...
    const appId = INSTA_APP_ID;
    const appSecret = INSTA_APP_SECRET;
    const redirectUri = 'https://oolook.azurewebsites.net/login/insta/auth/callback';
